...
public class PlayerBoom : MonoBehaviour
{
    ...
    public void OnBoom()
    {
        ...
        GameObject[] projectTiles = GameObject.FindGameObjectsWithTag("EnemyProjectile");
        for(int i = 0; i < projectTiles.Length; i++)
        {
            projectTiles[i].GetComponent<EnemyProjectile>().OnDie();
        }
